...
interface DetailCategoryScreenProps {}
const renderers = {
...
const DetailCategoryScreen = ({
  navigation,
  route,
}: BaseNavigationProps<MainParamList, Routes.DetailCategoryScreen>) => {
        ...
        <View style={{paddingHorizontal: 15}}>
          ...
          <View style={[Theme.flexRowSpace, styles.borderEnd]}>
            {data.type == 'ADVERTISEMENT' ? (
              ...
              <View>
                <Text semiBold color={colors.primary} lineHeight={28} size={18}>
