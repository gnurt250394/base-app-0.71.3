...
interface ItemCartCategoryColaboratorProps {
...
const ItemCartCategoryColaborator = ({
  item,
  onDeleteItem,
  isCheck,
  onChangePrice,
  customer,
  onDetail,
}: ItemCartCategoryColaboratorProps) => {
              ...
              <View style={[Theme.flexRowSpace]}>
                <View style={[Theme.flexRow, Theme.flex1]}>
                  <ButtonIcon
                    ...
                    onPress={onUpdateCart(item.amount - 1)}
                  />
...
export default ItemCartCategoryColaborator;
